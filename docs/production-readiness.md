...
- [x] Authentication, authorization, transport security, rate limits, and audit requirements are specified.
  ...
  + `--tls-crl` for cpp/python/go (+ perl/ruby/erlang when toolchains are installed). Residual:
  quotas, multi-tenant Phase 8 remainder (ADR 0028 deferred), and physical E3 honesty.
