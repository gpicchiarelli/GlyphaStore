...
| concurrent maintenance | foreground cost and reclaim progress for disabled/cooperative/background policy | mixed public GET/PUT calls only; preload/flush/close/reopen/verification excluded |
