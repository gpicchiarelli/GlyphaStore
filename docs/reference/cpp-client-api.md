...
| Ruby | Planned under `sdk/ruby` ([roadmap](../architecture/ruby-sdk-roadmap.md)) | sync first: per-Worker mutex; AsyncClient (Fiber) in Phase 2; one client per forked worker process |
