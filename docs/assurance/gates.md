...
| `GATE-CONCURRENCY-SPEC` | public_contract | `IMPLEMENTATA` | `alpha` | `GS-CONCUR-PAIR-001`, `GS-CONCUR-LEGACY-001`, `GS-PROTO-WIRE-001`, `GS-PROTO-ERROR-001`, `GS-CORE-CLOSE-001` |
