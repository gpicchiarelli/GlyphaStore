...
harness includes Erlang in both cleartext and TLS matrices when OTP/rebar3 are available.
Ruby ships the same TLS train (opt-in TLS 1.3) as the other official SDKs.
