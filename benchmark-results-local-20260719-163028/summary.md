...
Generated at `2026-07-19T14:52:35+00:00` from 140 result(s).

> Local Apple M4 run with Low Power Mode enabled and advisory affinity. Use for profiling and large-regression triage, not absolute capacity claims.

Baseline report: `2026-07-14T13:10:23+00:00`.
...
| core-lto | index_insert | k=16, v=64, w=1, t=1, uniform | 13.43 M | +11.20% | 74.46 | — | — | — | — | 40.75 MiB | 0.00 |
| core-lto | index_replace | k=16, v=64, w=1, t=1, uniform | 9.98 M | -13.21% | 100.17 | — | — | — | — | 40.80 MiB | 0.00 |
| core-lto | index_find_hit | k=16, v=64, w=1, t=1, uniform | 12.46 M | +0.20% | 80.26 | — | — | — | — | 42.34 MiB | 0.00 |
| core-lto | index_find_miss | k=16, v=64, w=1, t=1, uniform | 13.78 M | +1.17% | 72.58 | — | — | — | — | 48.47 MiB | 0.00 |
| core-lto | index_churn_miss | k=16, v=64, w=1, t=1, uniform | 16.77 M | — | 59.62 | — | — | — | — | 64.73 MiB | 0.00 |
| core-lto | index_erase | k=16, v=64, w=1, t=1, uniform | 11.44 M | -6.45% | 87.45 | — | — | — | — | 64.73 MiB | 0.00 |
| core-lto | store_put | k=16, v=64, w=1, t=1, uniform | 4.00 M | -20.04% | 250.07 | — | — | — | — | 101.16 MiB | 0.00 |
| core-lto | store_get_copy | k=16, v=64, w=1, t=1, uniform | 3.68 M | -20.11% | 271.65 | — | — | — | — | 101.27 MiB | 0.00 |
| core-lto | store_put_get_copy | k=16, v=64, w=1, t=1, uniform | 3.61 M | -23.96% | 276.82 | — | — | — | — | 101.30 MiB | 0.00 |
| core-lto | store_read_after_write_copy | k=16, v=64, w=1, t=1, uniform | 4.40 M | -27.75% | 227.08 | — | — | — | — | 101.30 MiB | 0.00 |
...
| index-key-32 | index_insert | k=32, v=64, w=1, t=1, uniform | 7.97 M | — | 125.44 | — | — | — | — | 64.23 MiB | 0.00 |
| index-key-32 | index_replace | k=32, v=64, w=1, t=1, uniform | 7.22 M | — | 138.55 | — | — | — | — | 64.31 MiB | 0.00 |
| index-key-32 | index_find_hit | k=32, v=64, w=1, t=1, uniform | 7.29 M | — | 137.12 | — | — | — | — | 64.33 MiB | 0.00 |
| index-key-32 | index_find_miss | k=32, v=64, w=1, t=1, uniform | 9.44 M | — | 105.99 | — | — | — | — | 81.19 MiB | 0.00 |
| index-key-32 | index_churn_miss | k=32, v=64, w=1, t=1, uniform | 9.51 M | — | 105.14 | — | — | — | — | 97.97 MiB | 0.00 |
| index-key-32 | index_erase | k=32, v=64, w=1, t=1, uniform | 3.93 M | — | 254.49 | — | — | — | — | 99.33 MiB | 0.00 |
...
| scaling-affine-w10 | store_parallel_put | k=16, v=64, w=10, t=10, worker-affine | 14.63 M | — | 68.37 | — | — | — | — | 91.03 MiB | 0.00 |
| scaling-affine-w10 | store_parallel_get_copy | k=16, v=64, w=10, t=10, worker-affine | 18.55 M | — | 53.90 | — | — | — | — | 97.95 MiB | 0.00 |
| scaling-affine-w10 | store_parallel_read_after_write_copy | k=16, v=64, w=10, t=10, worker-affine | 19.06 M | — | 52.48 | — | — | — | — | 98.00 MiB | 0.00 |
...
| scaling-uniform-w10 | store_parallel_put | k=16, v=64, w=10, t=10, uniform | 3.30 M | — | 303.48 | — | — | — | — | 85.30 MiB | 0.00 |
| scaling-uniform-w10 | store_parallel_get_copy | k=16, v=64, w=10, t=10, uniform | 3.99 M | — | 250.91 | — | — | — | — | 87.78 MiB | 0.00 |
| scaling-uniform-w10 | store_parallel_read_after_write_copy | k=16, v=64, w=10, t=10, uniform | 4.96 M | — | 201.49 | — | — | — | — | 87.81 MiB | 0.00 |
...
| server-latency-w2-p32 | server_tcp_read_after_write | k=16, v=64, w=2, t=2, owner-bound, p=32 | 1.69 M | +23.19% | 590.87 | 67.25 µs | 110.08 µs | 144.50 µs | 1.03 ms | 86.34 MiB | 270.79 M |
...
| server-size-k16-v0 | server_tcp_read_after_write | k=16, v=0, w=4, t=4, owner-bound, p=128 | 9.01 M | — | 110.96 | — | — | — | — | 43.58 MiB | 865.17 M |
...
| server-tcp-w1-p1 | server_tcp_read_after_write | k=16, v=64, w=1, t=1, owner-bound, p=1 | 90.78 k | +5.23% | 11,015.70 | — | — | — | — | 71.20 MiB | 14.52 M |
| server-tcp-w1-p128 | server_tcp_read_after_write | k=16, v=64, w=1, t=1, owner-bound, p=128 | 2.27 M | -9.00% | 440.68 | — | — | — | — | 68.86 MiB | 363.08 M |
| server-tcp-w1-p32 | server_tcp_read_after_write | k=16, v=64, w=1, t=1, owner-bound, p=32 | 1.31 M | -8.96% | 760.81 | — | — | — | — | 68.36 MiB | 210.30 M |
| server-tcp-w1-p8 | server_tcp_read_after_write | k=16, v=64, w=1, t=1, owner-bound, p=8 | 571.55 k | -1.90% | 1,749.63 | — | — | — | — | 67.33 MiB | 91.45 M |
| server-tcp-w2-p1 | server_tcp_read_after_write | k=16, v=64, w=2, t=2, owner-bound, p=1 | 120.39 k | +54.56% | 8,306.44 | — | — | — | — | 72.16 MiB | 19.26 M |
| server-tcp-w2-p128 | server_tcp_read_after_write | k=16, v=64, w=2, t=2, owner-bound, p=128 | 4.04 M | +45.72% | 247.30 | — | — | — | — | 69.34 MiB | 646.98 M |
| server-tcp-w2-p32 | server_tcp_read_after_write | k=16, v=64, w=2, t=2, owner-bound, p=32 | 2.36 M | +16.95% | 423.51 | — | — | — | — | 72.06 MiB | 377.79 M |
| server-tcp-w2-p8 | server_tcp_read_after_write | k=16, v=64, w=2, t=2, owner-bound, p=8 | 612.85 k | -15.86% | 1,631.71 | — | — | — | — | 69.17 MiB | 98.06 M |
| server-tcp-w4-p1 | server_tcp_read_after_write | k=16, v=64, w=4, t=4, owner-bound, p=1 | 170.46 k | +48.57% | 5,866.36 | — | — | — | — | 81.05 MiB | 27.27 M |
| server-tcp-w4-p128 | server_tcp_read_after_write | k=16, v=64, w=4, t=4, owner-bound, p=128 | 5.42 M | +14.09% | 184.46 | — | — | — | — | 70.05 MiB | 867.40 M |
| server-tcp-w4-p32 | server_tcp_read_after_write | k=16, v=64, w=4, t=4, owner-bound, p=32 | 3.08 M | +20.32% | 325.08 | — | — | — | — | 77.95 MiB | 492.19 M |
| server-tcp-w4-p8 | server_tcp_read_after_write | k=16, v=64, w=4, t=4, owner-bound, p=8 | 1.23 M | +47.28% | 812.91 | — | — | — | — | 75.37 MiB | 196.82 M |
| store-size-k16-v0 | store_put_get_copy | k=16, v=0, w=1, t=1, uniform | 4.09 M | — | 244.79 | — | — | — | — | 58.72 MiB | 0.00 |
| store-size-k16-v256 | store_put_get_copy | k=16, v=256, w=1, t=1, uniform | 3.74 M | — | 267.40 | — | — | — | — | 156.30 MiB | 0.00 |
...
| index-key-32 | 28a12ae | macos | arm64 | Apple LLVM 21.0.0 (clang-2100.1.1.101) |
...
| scaling-affine-w10 | 28a12ae | macos | arm64 | Apple LLVM 21.0.0 (clang-2100.1.1.101) |
...
| scaling-uniform-w10 | 28a12ae | macos | arm64 | Apple LLVM 21.0.0 (clang-2100.1.1.101) |
...
| server-size-k16-v0 | 28a12ae | macos | arm64 | Apple LLVM 21.0.0 (clang-2100.1.1.101) |
...
| store-size-k16-v0 | 28a12ae | macos | arm64 | Apple LLVM 21.0.0 (clang-2100.1.1.101) |
| store-size-k16-v256 | 28a12ae | macos | arm64 | Apple LLVM 21.0.0 (clang-2100.1.1.101) |
