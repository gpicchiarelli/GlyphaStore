...
## Copyright and license concerns

Project license and third-party attribution policy:
[docs/legal/licensing.md](docs/legal/licensing.md), [NOTICE](NOTICE),
[THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md). For suspected license/copyright violations that
are not security vulnerabilities, open a private channel as above or a public issue labeled
`legal` without attaching proprietary third-party source.
